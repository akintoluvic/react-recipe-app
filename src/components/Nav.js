              ...
              <div class="flex items-center -mx-6">
                ...
                <div class="lg:w-1/4 xl:w-1/5 pl-6 pr-6">
                  <div class="flex items-center">
                    <a href="/" class="block inline-flex">
                        <h1 class="text-xl  text-gray-700 font-bold w-auto hidden md:block"> GreeneRecipes</h1>
...
{/*   
                  ...
                  <div class="hidden lg:flex lg:items-center lg:justify-between xl:w-1/4 px-6">
                    ...
                    <div class="flex justify-start items-center text-gray-500">
                      <a class="block flex items-center hover:text-gray-700 mr-5" href="https://github.com/akintoluvic">
                      ...
                      <a class="block flex items-center hover:text-gray-700 mr-5" href="https://twitter.com/akintoluvic">
